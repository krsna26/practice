...
<title>Login Banner for Check Status</title>
...
<nav class="navbar navbar-expand-lg navbar-light fixed-top"
		...
		<!-- 	<a class="navbar-brand js-scroll-trigger">Lening Service</a> -->
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ml-auto">
					<li class="nav-item"><a class="nav-link js-scroll-trigger" href="loanStatus.loan?pan=${UserDetail.panNo}">Check Loan Status</a></li>
				</ul>
			</div>
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ml-auto">
